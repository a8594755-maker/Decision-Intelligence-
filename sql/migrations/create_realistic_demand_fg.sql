-- ============================================
-- Create Realistic FG Demand from Existing ERP Data
-- ============================================
-- This creates meaningful FG demand based on ERP BOM parent materials
-- Used for demonstrating BOM Explosion with real ERP data flow
...
INSERT INTO demand_fg (user_id, material_code, plant_id, time_bucket, demand_qty, uom, source, created_at, updated_at)
VALUES 
  ('291075be-3bee-43ff-a296-17c8eecd26a1', 'SG23', '1010', '2026-02-08', 800, 'PC', 'erp_sync', NOW(), NOW()),
  ('291075be-3bee-43ff-a296-17c8eecd26a1', 'SG23', '1010', '2026-02-15', 750, 'PC', 'erp_sync', NOW(), NOW()),
  ('291075be-3bee-43ff-a296-17c8eecd26a1', 'SG23', '1010', '2026-02-22', 900, 'PC', 'erp_sync', NOW(), NOW()),
  ('291075be-3bee-43ff-a296-17c8eecd26a1', 'MZ-TG-A17', '1710', '2026-02-08', 300, 'EA', 'erp_sync', NOW(), NOW()),
  ('291075be-3bee-43ff-a296-17c8eecd26a1', 'MZ-TG-A18', '1710', '2026-02-08', 250, 'EA', 'erp_sync', NOW(), NOW()),
  ('291075be-3bee-43ff-a296-17c8eecd26a1', 'MZ-RM-R14-01', '1710', '2026-02-08', 150, 'PC', 'erp_sync', NOW(), NOW())
ON CONFLICT (user_id, material_code, plant_id, time_bucket) 
DO UPDATE SET 
  demand_qty = EXCLUDED.demand_qty,
  uom = EXCLUDED.uom,
...
SELECT COUNT(*) as total_demand_fg FROM demand_fg WHERE source = 'erp_sync';
