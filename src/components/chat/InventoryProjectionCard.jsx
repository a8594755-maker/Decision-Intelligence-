...
export default function InventoryProjectionCard({ payload }) {
  ...
  return (
    <Card category="forecast" className="w-full border border-blue-200 dark:border-blue-800 bg-blue-50/60 dark:bg-blue-900/10">
      <div className="space-y-3">
        <div>
          ...
          <p className="text-xs text-[var(--text-muted)]">Run #{payload.run_id || 'N/A'} | {payload.total_rows || 0} projection rows</p>
        </div>
