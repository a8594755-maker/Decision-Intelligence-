...
const LINE_COLOR = {
  ...
  approval_decided:   'border-[var(--brand-500)]',
  approval_escalated: 'border-red-400',
  manager_reviewed:   'border-[var(--brand-500)]',
};
