        ...
        return (
          <div key={cat}>
            <div className="flex items-center gap-2 mb-3">
              <CatIcon className="w-4 h-4 text-[var(--brand-500)]" />
              <span className="text-xs font-semibold uppercase tracking-wide" style={{ color: 'var(--text-muted)' }}>
                {categoryLabels[cat] || cat}
              </span>
              <span className="text-xs px-1.5 py-0.5 rounded-full bg-[var(--surface-subtle)]" style={{ color: 'var(--text-muted)' }}>
                {artifacts.length}
              </span>
            </div>
                ...
                return (
                  <button
                    ...
                    className={`text-left p-4 rounded-xl border transition-all ${
                      isSelected
                        ? 'border-[var(--brand-500)] bg-[var(--accent-active)] shadow-sm'
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="w-9 h-9 rounded-lg bg-[var(--surface-card)] border border-[var(--border-default)] flex items-center justify-center flex-shrink-0">
                        <ArtIcon className="w-4 h-4 text-[var(--brand-500)]" />
                      </div>
...
function RevisionDiffView({ runs }) {
  ...
  return (
    <div className="p-4 rounded-2xl border" style={{ borderColor: 'var(--border-default)', backgroundColor: 'var(--surface-card)' }}>
      <div className="flex items-center gap-2 mb-3">
        <GitCompare className="w-4 h-4 text-[var(--brand-500)]" />
    ...
    <div className="h-full flex flex-col">
      <div className="px-5 py-4 border-b flex-shrink-0" style={{ borderColor: 'var(--border-default)' }}>
        ...
        <div className="flex flex-wrap items-center gap-2 mt-3 text-xs" style={{ color: 'var(--text-muted)' }}>
          <span className="px-2 py-0.5 rounded-full bg-[var(--accent-active)] text-[var(--brand-600)] font-medium capitalize">
            {workflowType}
          </span>
          <span className="px-2 py-0.5 rounded-full bg-[var(--surface-subtle)]">
        ...
        {activeTab === 'deliverable' ? (
          <div className="space-y-4">
            ...
            <section className="p-5 rounded-2xl border" style={{ borderColor: 'var(--border-default)', backgroundColor: 'var(--surface-card)' }}>
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 rounded-2xl flex items-center justify-center border" style={{ borderColor: 'var(--border-default)', backgroundColor: 'var(--surface-subtle)' }}>
                  <DeliverableIcon className="w-5 h-5 text-[var(--brand-500)]" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-[11px] font-semibold uppercase tracking-wide" style={{ color: 'var(--text-muted)' }}>
                    ...
                    <ul className="mt-3 space-y-2">
                      {section.items.map((entry, index) => (
                        <li key={`${section.label}-${index}`} className="flex items-start gap-2 text-sm" style={{ color: 'var(--text-secondary)' }}>
                          <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[var(--brand-500)] flex-shrink-0" />
                          <span>{entry}</span>
                        </li>
                      ))}
                    </ul>
            ...
            {previewExcerpt && (
              <section className="p-4 rounded-2xl border" style={{ borderColor: 'var(--border-default)', backgroundColor: 'var(--surface-card)' }}>
                <div className="flex items-center gap-2 mb-2">
                  <FileText className="w-4 h-4 text-[var(--brand-500)]" />
                  <h4 className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>
                    Draft excerpt
                  </h4>
                </div>
            ...
            <section className="grid grid-cols-1 xl:grid-cols-2 gap-4">
              <div className="p-4 rounded-2xl border" style={{ borderColor: 'var(--border-default)', backgroundColor: 'var(--surface-card)' }}>
                <div className="flex items-center gap-2 mb-2">
                  <Paperclip className="w-4 h-4 text-[var(--brand-500)]" />
                  <h4 className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>
                    Deliverable package
                  </h4>
                </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center flex-wrap gap-2">
              ...
              {traceCompleteness?.missing?.length > 0 && (
                <span className="text-[10px] px-2 py-0.5 rounded-full bg-[var(--surface-subtle)]" style={{ color: 'var(--text-muted)' }}>
            ...
            {governanceItems.length > 0 && (
              <div className="p-3 rounded-xl border" style={{ borderColor: 'var(--border-default)', backgroundColor: 'var(--surface-card)' }}>
                <div className="flex items-center gap-2 mb-2">
                  <Shield className="w-3.5 h-3.5 text-[var(--brand-500)]" />
                  <span className="text-xs font-semibold" style={{ color: 'var(--text-primary)' }}>Governance Approvals</span>
                  <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-[var(--surface-subtle)]" style={{ color: 'var(--text-muted)' }}>
              ...
              <div className="p-3 rounded-xl border" style={{ borderColor: 'var(--border-default)', backgroundColor: 'var(--surface-card)' }}>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {Object.entries(item.input_context.capability_policy).map(([key, val]) => (
                    <span key={key} className="text-[10px] px-2 py-0.5 rounded-full bg-[var(--surface-subtle)]" style={{ color: 'var(--text-secondary)' }}>
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-4 pt-2 pb-4">
          ...
          <textarea
            className="w-full mt-3 px-3 py-2.5 rounded-xl border text-sm resize-none focus:outline-none focus:ring-2 focus:ring-[var(--brand-500)]"
            style={{
              borderColor: 'var(--border-default)',
  ...
  return (
    <button
      ...
      className={`w-full text-left px-3 py-3 rounded-xl transition-all ${
        isSelected
          ? 'bg-[var(--accent-active)] shadow-sm'
    ...
    >
      ...
      {workerName && (
        <div className="flex items-center gap-1 mt-1">
          <Bot className="w-3 h-3 text-[var(--brand-500)]" />
          <span className="text-[10px]" style={{ color: 'var(--text-muted)' }}>{workerName}</span>
        </div>
      )}
      <div className="flex items-center gap-1.5 mt-1.5 flex-wrap">
        <span className="text-xs px-1.5 py-0.5 rounded-full text-[var(--brand-600)] bg-[var(--accent-active)] capitalize font-medium">
    ...
    <div className="h-full flex flex-col" style={{ backgroundColor: 'var(--surface-bg)' }}>
      ...
      >
        <div className="flex items-center gap-3">
          <CheckCircle2 className="w-4.5 h-4.5 text-[var(--brand-500)]" />
        ...
        <main className="flex-1 min-w-0 overflow-hidden">
          {selectedItem ? (
            ...
            <div className="flex flex-col items-center justify-center h-full gap-3">
              <div className="w-14 h-14 rounded-2xl bg-[var(--surface-subtle)] flex items-center justify-center">
