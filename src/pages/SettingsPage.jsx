          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[var(--accent-active)] p-4 rounded-lg border border-[var(--brand-500)]">
                  <div className="flex items-start gap-2">
                    <AlertCircle className="w-5 h-5 text-[var(--brand-600)] mt-0.5" />
            ...
            <Card>
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative w-14 h-7 rounded-full transition-colors ${darkMode ? 'bg-[var(--brand-600)]' : 'bg-stone-300'}`}
                >
