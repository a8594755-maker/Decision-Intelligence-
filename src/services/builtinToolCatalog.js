...
export const BUILTIN_TOOLS = [
...

  {
    ...
    description: 'Execute SQL queries on enterprise data via DuckDB (PostgreSQL-compatible). Dataset A (Olist E-Commerce): customers, orders, order_items, payments, reviews, products, sellers, geolocation, category_translation. Dataset B (DI Operations): suppliers, materials, inventory_snapshots, po_open_lines, goods_receipts. Supports CTEs (WITH ... AS), window functions (ROW_NUMBER, RANK, LAG, LEAD, OVER/PARTITION BY), PERCENTILE_CONT, MEDIAN, DATE_TRUNC, EXTRACT, and all standard SQL.',
    category: TOOL_CATEGORY.DATA_ACCESS,
